  ...
  <div class="box_1">
    <h3>
      ...
      <form method="GET" class="sort" name="listform">
        ...
        <a href="javascript:;" onClick="javascript:display_mode('list')"><img src="themes/cpts_467_tq/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a>
        <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="themes/cpts_467_tq/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a>
        <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="themes/cpts_467_tq/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;
        ...
        <input type="image" name="imageField" src="themes/cpts_467_tq/images/bnt_go.gif" alt="go"/>
